...
- **R-O2: Funding horizon vs. slow validation.** The honest efficacy timeline (Phases 4–8) outlasts typical grant cycles. *Mitigation:* stage results (retrieval bench study lands early and is publishable); align with ETEN-style innovation funding.
